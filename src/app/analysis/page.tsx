...
import OutbreakMap from "@/components/my-components/outbreakMap";
import { sendNotification } from "@/components/my-components/sendNotifications";
import {fetchFCMTokens }from "@/components/my-components/fetchFCM";
// Dynamically import AQIMap with SSR disabled
const AQIMap = dynamic(
  () => import('@/components/my-components/aqiMap'),
  { ssr: false }
);
...
export default function Home() {
  ...
  const updateReportStatus = async ({reportId, newStatus}:{reportId:any, newStatus:any}) => {
    try {
  ...
  return (
    <div className="p-6 flex flex-col gap-8">
      {/* Maps Section */}
        <h1 className='text-center font-semibold text-4xl'>Realtime Analysis and Action</h1>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <button
                      onClick={() => {
                        ...
                        sendNotification("Heyy!!", "Your report has been acknowledged");
                      }}
                    ...
                    <button
                      onClick={() => {
                        ...
                        sendNotification("Heyy!!", "Your report has been resolved");
                      }}
                      className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
